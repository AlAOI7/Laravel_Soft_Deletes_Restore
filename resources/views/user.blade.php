    ...
    <table id="example" class="table table-bordered table-hover display">
        <thead>
            <tr>
                ...
                <th scope="col">حذف ناعم</th>
                <th scope="col">حذف قسري</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($users as $rs)
                <tr>
                    ...
                    <td>{{$rs->name}}</td>
                    <td>{{$rs->email}}</td>
                <td ><a href="softDelete/{{$rs->id}}" class="text-warning btn"><i class="fa fa-solid fa-trash"></i> حذف</a></td>
                <td ><a href="forceDelete/{{$rs->id}}" class="text-danger btn"><i class="fa fa-solid fa-trash"></i> حذف نهائي</a></td>
                </tr>
            @endforeach
        </tbody>
    </table>
